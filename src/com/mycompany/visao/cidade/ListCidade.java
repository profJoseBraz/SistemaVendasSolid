...
public class ListCidade extends javax.swing.JFrame {
     ...
     */
    public ListCidade(DaoCidade daoCidade, DaoEstado daoEstado) {
        initComponents();
        ...
        try{
            if (evt.getClickCount() == 2){
                ...
                if(Formularios.cadCidade == null)
                    Formularios.cadCidade = new CadCidade(daoCidade, daoEstado);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListCidade(daoCidade, daoEstado).setVisible(true);
            }
        });
    }
