...
public class CadCidade extends javax.swing.JFrame {
    private static DaoCidade daoCidade;
    private static DaoEstado daoEstado;
     ...
     * @param daoEstado
     */
    public CadCidade(DaoCidade daoCidade, DaoEstado daoEstado) {
        initComponents();
    ...
    private void inserir(){
        if (daoCidade.inserir(new ModCidade(Integer.parseInt(tfId.getText()), Integer.parseInt(tfIdEstado.getText()), tfNome.getText()))){
    ...
    private void alterar(){
        if (daoCidade.alterar(new ModCidade(Integer.parseInt(tfId.getText()), Integer.parseInt(tfIdEstado.getText()), tfNome.getText()))){
    ...
    private void excluir(){
        if (daoCidade.excluir(new ModCidade(Integer.parseInt(tfId.getText())))){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadCidade(daoCidade, daoEstado).setVisible(true);
            }
        });
    }
